...
// 	UpdateSubTaskTests(ctx context.Context, id int, testIDs []int) error
...
// 	UpdateProblemListProblems(ctx context.Context, id int, problemIDs []int) error
...
// 	GetProblemSettings(ctx context.Context, problemID int) (*ProblemEvalSettings, error)
