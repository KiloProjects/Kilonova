		...
		return (
			<div class="segment-container">
				<form onsubmit={this.update.bind(this)}>
					...
					<div class="block my-2">
						<label>
							<span class="form-label">{getText("stackLimit")}:</span>
							<input type="number" class="form-input" id="memoryStack" placeholder="Limită de memorie (stack)" min="0" step="128" max="131072" value={problem.stack_limit} onchange={this.updater('stack_limit')}/>
							<span class="ml-1 text-xl">KB</span>
						</label>
					</div>
					<div class="block my-2">
